...
const handleRequest = frames(async (ctx) => {
  ...
  return {
    ...
    buttons: [
        <Button action="post" target="/promoteChallenger">Promote Contender 1</Button>,
        <Button action="post" target="/promoteChallenger">Promote Contender 2</Button>,
        <Button action="post" target="/gameDetails">Go Back</Button>
    ],
  };
});
